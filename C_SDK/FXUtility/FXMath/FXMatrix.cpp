...
FX_VOID FX_MatrixRotX(double L[4][4], double DegAngle, double T[4][4])
{
	double sinv;
	double cosv;
	FX_SIN_COS_DEG(DegAngle, &sinv, &cosv);

	long i;
	for (i = 0; i < 3; i++)
	{
		T[i][0] = L[i][0];
		T[i][1] = -L[i][2] * sinv + L[i][1] * cosv;
		T[i][2] = L[i][1] * sinv + L[i][2] * cosv;
		T[i][3] = L[i][3];
	}
	T[3][0] = 0;
	T[3][1] = 0;
...
FX_VOID	FX_MatrixRotY(double L[4][4], double DegAngle, double T[4][4])
{
	double sinv;
	double cosv;
	FX_SIN_COS_DEG(DegAngle, &sinv, &cosv);
	...
	for (i = 0; i < 3; i++)
	{
		T[i][0] = L[i][0] * cosv + L[i][2] * sinv;
		T[i][1] = L[i][1];
		T[i][2] = -L[i][0] * sinv + L[i][2] * cosv;
		T[i][3] = L[i][3];
	}
	T[3][0] = 0;
	T[3][1] = 0;
...
FX_VOID	 FX_MatrixRotZ(double L[4][4], double DegAngle, double T[4][4])
{
	double sinv;
	double cosv;
	FX_SIN_COS_DEG(DegAngle, &sinv, &cosv);
...
FX_VOID FX_MatrixMoveXYZ(double L[4][4], double xyz[3], double T[4][4])
{
	long i;
	for (i = 0; i < 3; i++)
	{

...
#define FX_SDK_MINOR_VERSION 6UL /**< Minor version number */
...
{
    FX_USER_FBK_NULL = 0,
    FX_USER_FBK_ARM0_CMD_FFDTOR = 100, ///< Arm0's FFD torque command, unit in N*m
    FX_USER_FBK_ARM1_CMD_FFDTOR = 200, ///< Arm1's FFD torque command, unit in N*m
    FX_USER_FBK_BODY_CMD_FFDTOR = 300, ///< Body's FFD torque command, unit in N*m
}FXUserFbkType;
